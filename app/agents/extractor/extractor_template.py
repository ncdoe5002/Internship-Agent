...
class AgmtHeaderStg(BaseModel):
    ...
    sender: Optional[str] = Field(
        default=None,
        description="Party sending the agreement or originating operator."
    )
    ...
    rev_no: Optional[int] = Field(
        default=None,
        description="Agreement revision number."
    )
    ...
    end_date: Optional[str] = Field(
        default=None,
        description="Agreement termination or expiry date."
    )

    remarks: Optional[str] = Field(
        default=None,
        description="General remarks or notes related to the agreement."
    )

    data_level: Optional[str] = Field(
        default=None,
        description="Data processing or agreement classification level."
    )
    ...
    created_date: Optional[str] = Field(
        default=None,
        description="Date when the agreement record was created."
    )
    ...
    total_agmt_month: Optional[int] = Field(
        default=None,
        description="Total agreement duration in months."
    )

    is_rerating_reqd: Optional[bool] = Field(
        default=None,
        description="Indicates whether rerating is required."
    )
    ...
    gprs_limit: Optional[float] = Field(
        default=None,
        description="GPRS limit or threshold value."
    )
    ...
    baseline_value: Optional[float] = Field(
        default=None,
        description="Numeric baseline threshold or committed value."
    )

    commit_rule: Optional[str] = Field(
        default=None,
        description="Commitment calculation rule."
    )

    commit_base_field: Optional[str] = Field(
        default=None,
        description="Field used as the basis for commitment calculation."
    )

    commit_value: Optional[float] = Field(
        default=None,
        description="Numeric commitment value."
    )

    is_group_client: Optional[bool] = Field(
        default=None,
        description="Indicates whether client belongs to a group."
    )
    ...
    regen_required: Optional[bool] = Field(
        default=None,
        description="Indicates whether regeneration is required."
    )

    is_tap_level_agmt: Optional[bool] = Field(
        default=None,
        description="Indicates whether agreement is defined at TAP level."
    )

    is_partial_client: Optional[bool] = Field(
        default=None,
        description="Indicates whether partial client processing applies."
    )
    ...
    baseline_level: Optional[str] = Field(
        default=None,
        description="Level at which baseline calculation is applied."
    )
    ...
    modified_user: Optional[str] = Field(
        default=None,
        description="User who last modified the agreement."
    )
    ...
    agmt_type: Optional[str] = Field(
        default=None,
        description="Agreement type or category."
    )

    bulk_id: Optional[str] = Field(
        default=None,
        description="Bulk processing identifier if available."
    )
    ...
    agmt_level_rc_type: Optional[str] = Field(
        default=None,
        description="Agreement level recurring charge type."
    )
    ...
    imsi_activation_type: Optional[str] = Field(
        default=None,
        description="Type of IMSI activation."
    )

    imsi_activation_criteria: Optional[str] = Field(
        default=None,
        description="Criteria required for IMSI activation."
    )

    rap_chrg: Optional[float] = Field(
        default=None,
        description="RAP charging value."
    )

    rap_vol: Optional[float] = Field(
        default=None,
        description="RAP volume value or threshold."
    )

    exchange_rate_type: Optional[str] = Field(
        default=None,
        description="Exchange rate calculation type."
    )

    agmt_level_rc_var_type: Optional[str] = Field(
        default=None,
        description="Agreement level recurring charge variable type."
    )

    agmt_doc_status: Optional[str] = Field(
        default=None,
        description="Agreement document approval or processing status."
    )

    agmt_nego_status: Optional[str] = Field(
        default=None,
        description="Agreement negotiation status."
    )

    inc_in_accrl_rpt: Optional[bool] = Field(
        default=None,
        description="Whether agreement is included in accrual reports."
    )

    is_m2m_applcbl: Optional[bool] = Field(
        default=None,
        description="Whether machine-to-machine (M2M) processing applies."
    )

    agmt_verified: Optional[bool] = Field(
        default=None,
        description="Whether agreement has been verified."
    )

    agmt_verified_by: Optional[str] = Field(
        default=None,
        description="Person or user who verified the agreement."
    )

    agmt_verified_date: Optional[str] = Field(
        default=None,
        description="Date when agreement verification occurred."
    )
...
class IOTAgreement(BaseModel):
    ...
    model: Optional[AgmtModelsStg] = None
    normal_model: Optional[AgmtMdlNormalStg] = None
    commitment: Optional[AgmtCommitment] = None