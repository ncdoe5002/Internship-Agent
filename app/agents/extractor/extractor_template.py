...
class AgmtHeaderStg(BaseModel):
    ...
    modified_date: Optional[str] = Field(
        default=None,
        description="Date or timestamp when the record was last modified."
    )
    ...
    rap_vol: Optional[float] = Field(
        default=None,
        description="RAP volume threshold or tolerance unit count."
    )
    ...
    agmt_verified_date: Optional[str] = Field(
        default=None,
        description="Date when document verification was completed."
    )
class AgmtModelsStg(BaseModel):
    ...
    agmt_id: Optional[str] = Field(
        default=None,
        description="Unique identifier of the parent agreement."
    )
...
class AgmtCommitment(BaseModel):
    ...
    agmt_id: Optional[str] = Field(
        default=None,
        description="Unique identifier of the associated agreement."
    )
...
class IOTAgreement(BaseModel):
    ...
    model: Optional[AgmtModelsStg] = Field(
        default=None,
        description="High-level pricing model structure definition."
    )
